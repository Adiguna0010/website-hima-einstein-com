...
export default function Mitra() {
  return (
    <div className="relative pt-24 pb-16 space-y-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-slate-800">
      ...
      <div className="absolute bottom-1/4 right-0 w-64 h-64 bg-gold-light/5 glow-orb"></div>
      ...
      <div className="text-center max-w-2xl mx-auto space-y-6">
        ...
        <div className="space-y-3">
          <span className="text-xs font-bold text-gold-dark uppercase tracking-widest">Kemitraan</span>
          <h1 className="text-3xl sm:text-4xl font-extrabold uppercase text-slate-900">MITRA EINSTEIN</h1>
          <p className="text-slate-500 text-sm leading-relaxed font-light max-w-lg mx-auto">
            Halaman kemitraan HIMA EINSTEIN sedang dalam tahap pengembangan. 
            Kami membuka peluang kerja sama dengan berbagai pihak untuk memajukan organisasi dan mahasiswa.
          </p>
        </div>
        ...
        <div className="p-8 bg-white border border-gold-border rounded-2xl shadow-sm space-y-4">
          ...
          <p className="text-xs text-slate-500 leading-relaxed max-w-sm mx-auto">
            Informasi program kemitraan, sponsor, dan kolaborasi akan segera tersedia di halaman ini. 
